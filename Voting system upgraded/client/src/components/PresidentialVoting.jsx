...
import { Vote, CheckCircle2, ShieldAlert, AlertTriangle, ArrowLeft, ArrowRight } from 'lucide-react';

export default function PresidentialVoting({ positionData, onVoteSubmitted, electionId, apiBaseUrl, sessionId }) {
  ...
  return (
    <div>
      ...
      <div className="section-header">
        <div style={{ display: 'inline-block', color: 'var(--primary)', fontWeight: 800, fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
          STEP 1 OF 2
        </div>
        <h2 className="section-title">Vote for President</h2>
        <p className="section-subtitle">
          Examine the official presidential candidates below and select your preferred candidate. You may cast exactly 1 vote.
        </p>
      </div>
        ...
        <div className="modal-overlay">
          <div className="modal-content">
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.25rem' }}>
              ...
              <div>
                <h3 style={{ fontSize: '1.2rem', fontWeight: 800 }}>Confirm Presidential Vote</h3>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '0.88rem', color: 'var(--secondary)', fontWeight: 600, marginTop: '0.2rem' }}>
              ...
              <div style={{
                ...
                Are you sure you want to vote for <strong>{selectedCandidate.name}</strong> for President? You cannot change your vote after submission.
              </div>
            </div>
